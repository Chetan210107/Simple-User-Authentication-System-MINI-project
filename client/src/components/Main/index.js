...
const Main = ({ startQuiz }) => {
  ...
  const fetchData = () => {
    ...
    setTimeout(() => {
      let filteredQuestions = mockData;
      ...
      if (questionsType !== '0') {
        filteredQuestions = filteredQuestions.filter(
          question => question.type === questionsType
        );
      }
      ...
      if (filteredQuestions.length < numOfQuestions) {
        const message = (
          <p>
            There aren't enough questions for your query.
            <br />
            <br />
      ...
      const results = filteredQuestions.slice(0, numOfQuestions);
